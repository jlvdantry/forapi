...
--alter table forapi.his_menus alter usuario_movto  type name ;
alter table forapi.his_menus_pg_tables alter usuario_modifico  type name ;
...
psql jc104 -U jc104  -h localhost < src/bd/cambio_menus_columnas.sql
