...
fin
psql jc101 -U jc101  -h localhost < $0.sql
pg_dump jc101 -U jc101  -h localhost  -s -n forapi -x  > src/bd/forapi_esquema.sql
pg_dump jc101 -U jc101  -h localhost  -a -n forapi -x  > src/bd/forapi_insert.sql
rm $0.sql
