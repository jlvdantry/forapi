...
DatePicker.days = ["L", "M", "Mc", "J", "V", "S", "D"];
...
DatePicker.prototype.create = function ( doc ) {
	...
	this._el.setAttribute('id', 'datePicker_');
	this._el.setAttribute('name', 'datePicker_');
...
//		alert('typeof click ' + typeof this.onchange);
		d.setDate( n );
		dp.setDate( d );
		dp.onchange();
...
//        alert('getdate'+this._none+' selecteddate'+this._selectedDate);
